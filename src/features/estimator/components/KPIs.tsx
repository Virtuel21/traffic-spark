...
export default function KPIs({ baseline, estimated, incremental, keywords, improvingShare }: KPIProps) {
  return (
    <section className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4">
      ...
      <KPICard title="Sessions estimées" help="Attendu déterministe du modèle." value={fmt(estimated)} />
